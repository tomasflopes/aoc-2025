...
for i, ((x, y, z, xx, yy, zz), _) in enumerate(list(dists.items())):
    ...
    for circuit in circuits:
        if (x, y, z) in circuit: first_circuit = circuit
        elif (xx, yy, zz) in circuit: second_circuit = circuit
    if first_circuit and not second_circuit: first_circuit.add((xx, yy, zz))
    elif not first_circuit and second_circuit: second_circuit.add((x, y, z))
    elif not first_circuit and not second_circuit: circuits.append(set([(x, y, z), (xx, yy, zz)]))
